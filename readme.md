<h1>Start html template ( scss )</h1>

<h2>How to use OptimizedHTML</h2>

<ol>
	<li><a href="https://github.com/Andrey-VM/start-html-scss/archive/master.zip">Download</a> <strong>start-html-scss template</strong> from GitHub;</li>
